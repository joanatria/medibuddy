...
export default function MedicationTab() {
  ...
  const userIdentifier = Number(params.user);
  ...
  const handleInputChange = (
    ...
    console.log(setScheduleFormData);
  };
          ...
          <View style={styles.container}>
            ...
            <View style={styles.timeInputContainer}>
              <View style={[styles.formGroup, { flex: 1 }]}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    handleInputChange("initialQty", text.replace(/[^0-9]/g, ""))
                  }
            ...
            <View style={styles.formGroup}>
                ...
                >
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handleInputChange(
                        "interval",
                        (parseInt(text.replace(/[^0-9]/g, "")) || 0).toString()
                      )
                    }
                    keyboardType="numeric"
                  />
              ...
              <View style={{ padding: 10 }}>
                <TouchableOpacity
                  onPress={() => handleInputChange("isEveryHours", false)}
                >
                  <Text style={styles.checkboxText}>
            ...
            <View style={styles.formGroup}>
              ...
              <DropDownPicker
                ...
                setValue={(callback) => {
                  const value = callback(medicationFormData.notificationType);
